...
#pragma omp parallel private(i, j, tid) // added tid to private
    {
        for (i = 0; i < 1000; i++)
            for (j = 0; j < 1000; j++)
...
#pragma omp barrier
    ...
    */
    ...
    n = 10;
// changed n to firstprivate - otherwise value of n wont be passed to the parallel scope
#pragma omp parallel firstprivate(n)
    ...
    j = 10;
// changed n to lastprivate, otherwise last value of n wont be available outside of the parallel scope
